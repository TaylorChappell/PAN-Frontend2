...
function extractReply(data) {
  return data?.message?.content || data?.message || data?.reply || data?.content || data?.output?.text || data?.run?.message || "PAN finished the request.";
}
